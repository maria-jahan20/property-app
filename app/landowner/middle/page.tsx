  ...
  return (
    <div ref={containerRef} className="relative py-10 md:px-8 lg:px-12">
      ...
      <motion.div style={{ opacity: textOpacity, y: textY }} className="mb-16 max-w-4xl">
        <p className="text-lg text-gray-300 mr-56 ml-12 md:ml-4">
      ...
      {/* Main Grid Section */}
      <div className="grid grid-cols-[35%_65%] lg:grid-cols-[35%_65%] gap-4 lg:gap-6 md:gap-6">
        {/* Left Column - Image */}
        <motion.div
          style={{
        ...
        >
          <div className="relative w-full max-w-lg aspect-square overflow-hidden shadow-2xl">
            <Image src="/images/landownerImages/2.webp" alt="Business partnership" fill className="object-cover" priority />
          </div>
        </motion.div>

        {/* Right Column - Two Paragraphs in Grid */}
