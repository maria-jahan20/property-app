  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <Image
          src="/images/landownerImages/1.webp"
          alt="Chess Queen"
          fill
          priority
      ...
      >
        {/* Label */}
        <p className="text-sm md:text-sm font-light tracking-widest text-white/70 uppercase mb-4">
        Landowner

        </p>
        <p className="text-2xl md:text-xl font-light tracking-widest text-white/70 uppercase mb-4">BUILDING TOMORROW</p>
