...
export default function BannerSection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full h-[800px] overflow-hidden bg-black flex items-center justify-center"
    >
      {/* Background image - full screen */}
      <div className="absolute inset-0">
        <Image
          src="/images/propertiesImages/1.webp"
          alt="Chess Queen"
          fill
          priority
      ...
      >
        ...
        {/* Heading */}
        <h1 className="text-4xl md:text-4xl lg:text-4xl font-sm tracking-tight text-balance">
        CONCRETE WONDERS
        </h1>
      </motion.div>
    </section>
